...
namespace MyCSharpProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    Lection1.Task1.Run(); // marked

            /*---------- Arithmetic operators ---------*/

            //Lection2.Hometask.Run(); // marked
            //Lection2.Task1_2.Run(); // marked
            //Lection2.Task3.Run(); // marked
            //Lection2.Task4.Run(); // marked
            //Lection2.Task5.Run(); // marked
